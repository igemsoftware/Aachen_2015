...
namespace MCP.Settings
{
    public class MCPSettings : PropertyChangedBase
    {
        ...
        public string HomeDirectoryPath { get { return Settings.Default.HomeDirectoryPath; } set { Settings.Default.HomeDirectoryPath = value; OnPropertyChanged(); SaveSettings(); } }
